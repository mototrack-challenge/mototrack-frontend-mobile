    ...
    <View style={[styles.cardMoto]}>
      <View style={[styles.cabecalhoCardMoto]}>
        <Text style={[styles.title, { fontFamily: theme.fonts.bold }]}>
          {formatarModelo(moto.modelo)}
        </Text>
        <Image source={definirImagem(moto.modelo)} style={styles.imagemMoto} />
      </View>
      ...
      <View style={[styles.botoesCardMoto]}>
        ...
        <TouchableOpacity style={[styles.botaoCardMoto, styles.botaoServico]}>
          <Text
            style={[styles.textoBotao, { fontFamily: theme.fonts.regular }]}
          >
            Serviços
