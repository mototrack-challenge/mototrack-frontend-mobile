  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.title, { fontFamily: theme.fonts.bold }]}>
        Bem-vindo à MotoTrack
      </Text>
      <Text style={[styles.subtitle, { fontFamily: theme.fonts.regular }]}>
      ...
      {mensagem ? (
        <Text style={[styles.success, { fontFamily: theme.fonts.regular }]}>
          {mensagem}
        </Text>
      ) : null}
      {error ? (
      ...
      <TouchableOpacity style={styles.button} onPress={handleRegister}>
        <Text style={[styles.buttonText, { fontFamily: theme.fonts.regular }]}>
          Cadastrar
        </Text>
      </TouchableOpacity>
