...
export const ContainerPaginaCadastroDeServico = styled.View`
    flex: 1;
    padding: 10px;
    background-color: #FFF;
`;

export const ScrollPaginaCadastroDeServico = styled.ScrollView.attrs(() => ({
    contentContainerStyle: { justifyContent: 'center'}
}))``;

export const ContainerCadastroDoServico = styled.View`
    flex: 1;
    padding: 10px;
    background-color: #FFF;
`;

export const TituloCadastroDoServico = styled.Text`
    font-size: 18px;
    margin-bottom: 20px;
    text-align: left;
