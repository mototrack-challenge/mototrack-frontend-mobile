...
export const ContainerPaginaCadastroDeAlertas = styled.View`
    flex: 1;
    padding: 10px;
    background-color: #FFF;
`;

export const ScrollPaginaCadastroDeAlertas = styled.ScrollView.attrs(() => ({
    contentContainerStyle: { justifyContent: 'center'}
}))``;

export const ContainerCadastroDaAlerta = styled.View`
    flex: 1;
    padding: 10px;
    background-color: #FFF;
`;

export const TituloCadastroDaAlerta = styled.Text`
    font-size: 18px;
    margin-bottom: 20px;
    text-align: left;
